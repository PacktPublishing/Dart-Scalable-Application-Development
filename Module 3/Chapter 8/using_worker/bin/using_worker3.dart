...
class LevenshteinTask extends Task {
  ...
  Future<LevenshteinResult> execute() {
    ...
    return
        new Future.value(new LevenshteinResult(closestWord, closestDistance as int));
  }
}
...
// Output:
// Closest String to 'This is a pretty lame test string, but it is one that works!':
// 'This is a pretty lame test string, but it is one that works! You see?!
