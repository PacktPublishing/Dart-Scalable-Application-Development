library angular_view.web.angular_view.generated_expressions;
...
final Map<String, FieldGetter> getters = {
  ...
  r"typeFilter": (o) => o.typeFilter,
  r"companyFilterMap": (o) => o.companyFilterMap,
  r"salary": (o) => o.salary,
  r"maxSal": (o) => o.maxSal,
  r"cmp": (o) => o.cmp,
  r"companies": (o) => o.companies,
  r"company": (o) => o.company,
  r"stars": (o) => o.stars,
  r"star": (o) => o.star,
  r"ctrl": (o) => o.ctrl,
  r"jobs": (o) => o.jobs,
  r"job": (o) => o.job,
  r"rate_salary": (o) => o.rate_salary,
  r"type": (o) => o.type,
  r"selectedJob": (o) => o.selectedJob,
  r"posted": (o) => o.posted,
  r"skills": (o) => o.skills,
  r"skill": (o) => o.skill,
  r"info": (o) => o.info,
  r"clearFilters": (o) => o.clearFilters,
  r"starClass": (o) => o.starClass,
  r"starChar": (o) => o.starChar,
  r"selectJob": (o) => o.selectJob
};
final Map<String, FieldSetter> setters = {
  ...
  r"typeFilter": (o, v) => o.typeFilter = v,
  r"companyFilterMap": (o, v) => o.companyFilterMap = v,
  r"salary": (o, v) => o.salary = v,
  r"maxSal": (o, v) => o.maxSal = v,
  r"cmp": (o, v) => o.cmp = v,
  r"companies": (o, v) => o.companies = v,
  r"company": (o, v) => o.company = v,
  r"stars": (o, v) => o.stars = v,
  r"star": (o, v) => o.star = v,
  r"ctrl": (o, v) => o.ctrl = v,
  r"jobs": (o, v) => o.jobs = v,
  r"job": (o, v) => o.job = v,
  r"rate_salary": (o, v) => o.rate_salary = v,
  r"type": (o, v) => o.type = v,
  r"selectedJob": (o, v) => o.selectedJob = v,
  r"posted": (o, v) => o.posted = v,
  r"skills": (o, v) => o.skills = v,
  r"skill": (o, v) => o.skill = v,
  r"info": (o, v) => o.info = v
};
