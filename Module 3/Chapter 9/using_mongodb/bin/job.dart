...
//    });
  ...
  Job.fromMap(Map jobMap) {
    this.dbKey = jobMap["dbKey"];
    this.type = jobMap["type"];
    this.salary = jobMap["salary"];
    this.company = jobMap["company"];
    this.posted = DateTime.parse(jobMap["posted"]);
    this.open = jobMap["open"];
  }
}