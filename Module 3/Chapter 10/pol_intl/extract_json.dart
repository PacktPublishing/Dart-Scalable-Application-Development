 ...
 * information on those messages. It uses the analyzerexperimental parser
...
main(List<String> args) {
  ...
  parser.addFlag("warningsareerrors", defaultsTo: false,
  ...
  parser.parse(args);
  if (args.length == 0) {
    print('Usage: extract_to_json [outputdir=<dir>] [files.dart]');
